...
!function(t) {
    ...
    b.ui = b.ui || {};
    b.ui.version = "1.13.2";
    var o, i = 0, r = Array.prototype.hasOwnProperty, a = Array.prototype.slice;
    b.cleanData = (o = b.cleanData,
    function(t) {
    ...
    b.widget = function(t, i, e) {
        var s, o, n, r = {}, a = t.split(".")[0], h = a + "-" + (t = t.split(".")[1]);
        return e || (e = i,
        i = b.Widget),
        Array.isArray(e) && (e = b.extend.apply(null, [{}].concat(e))),
        b.expr.pseudos[h.toLowerCase()] = function(t) {
            return !!b.data(t, h)
        }
        ,
        b[a] = b[a] || {},
    ...
    b.widget.extend = function(t) {
        for (var e, i, s = a.call(arguments, 1), o = 0, n = s.length; o < n; o++)
            for (e in s[o])
                i = s[o][e],
                r.call(s[o], e) && void 0 !== i && (b.isPlainObject(i) ? t[e] = b.isPlainObject(t[e]) ? b.widget.extend({}, t[e], i) : b.widget.extend({}, i) : t[e] = i);
        return t
    }
    ,
    b.widget.bridge = function(n, e) {
        ...
        b.fn[n] = function(i) {
            ...
            return t ? this.length || "instance" !== i ? this.each(function() {
                ...
                !1) : e ? "function" != typeof e[i] || "_" === i.charAt(0) ? b.error("no such method '" + i + "' for " + n + " widget instance") : (t = e[i].apply(e, s)) !== e && void 0 !== t ? (o = t && t.jquery ? o.pushStack(t.get()) : t,
                !1) : void 0 : b.error("cannot call methods on " + n + " prior to initialization; attempted to call method '" + i + "'")
            }) : o = void 0 : (s.length && (i = b.widget.extend.apply(null, [i].concat(s))),
            this.each(function() {
                var t = b.data(this, r);
                t ? (t.option(i || {}),
                t._init && t._init()) : b.data(this, r, new e(i,this))
            })),
            o
        }
    }
    ...
    b.Widget.prototype = {
        ...
        _createWidget: function(t, e) {
            ...
            e !== this && (b.data(e, this.widgetFullName, this),
        ...
        option: function(t, e) {
            ...
            if ("string" == typeof t)
                ...
                t = (i = t.split(".")).shift(),
                i.length) {
                    for (s = n[t] = b.widget.extend({}, this.options[t]),
                    o = 0; o < i.length - 1; o++)
                        s[i[o]] = s[i[o]] || {},
                        s = s[i[o]];
                    if (t = i.pop(),
        ...
        _setOptionClasses: function(t) {
            ...
            for (e in t)
                ...
                t[e] !== this.options.classes[e] && s && s.length && (i = b(s.get()),
                ...
                for (var i, s = 0; s < t.length; s++)
                    ...
                    i = o.add ? (function() {
                        ...
                        o.element.each(function(t, e) {
                            b.map(r.classesElementLookup, function(t) {
                                return t
                            }).some(function(t) {
                                return t.is(e)
                            }) || i.push(e)
                    ...
                    b(b.uniqueSort(i.get().concat(o.element.get())))) : b(i.not(o.element).get()),
        ...
        _trigger: function(t, e, i) {
            ...
            if (i = i || {},
            (e = b.Event(e)).type = (t === this.widgetEventPrefix ? t : this.widgetEventPrefix + t).toLowerCase(),
    ...
    b.each({
        ...
        b.Widget.prototype["_" + n] = function(e, t, i) {
            ...
            s && b.effects && b.effects.effect[o] ? e[n](t) : o !== n && e[o] ? e[o](t.duration, t.easing, i) : e.queue(function(t) {
                b(this)[n](),
                i && i.call(e[0]),
                t()
            })
    ...
    b.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(t) {
                ...
                if (!0 === b.data(t.target, e.widgetName + ".preventClickEvent"))
                    return b.removeData(t.target, e.widgetName + ".preventClickEvent"),
        ...
        _mouseDown: function(t) {
            if (!n) {
                ...
                !0) : (!0 === b.data(t.target, this.widgetName + ".preventClickEvent") && b.removeData(t.target, this.widgetName + ".preventClickEvent"),
        ...
        _mouseUp: function(t) {
            ...
            t.target === this._mouseDownEvent.target && b.data(t.target, this.widgetName + ".preventClickEvent", !0),
            this._mouseStop(t)),
    ...
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            var e = this.options;
            return !(this.helper || e.disabled || 0 < b(t.target).closest(".ui-resizable-handle").length) && (this.handle = this._getHandle(t),
        ...
        _mouseDrag: function(t, e) {
            ...
            !e) {
                ...
                if (!1 === this._trigger("drag", t, e))
                    return this._mouseUp(new b.Event("mouseup",t)),
                    !1;
        ...
        _mouseStop: function(t) {
            var e = this
              , i = !1;
            return b.ui.ddmanager && !this.options.dropBehaviour && (i = b.ui.ddmanager.drop(this, t)),
            this.dropped && (i = this.dropped,
            this.dropped = !1),
            "invalid" === this.options.revert && !i || "valid" === this.options.revert && i || !0 === this.options.revert || "function" == typeof this.options.revert && this.options.revert.call(this.element, i) ? b(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10), function() {
        ...
        cancel: function() {
            return this.helper.is(".ui-draggable-dragging") ? this._mouseUp(new b.Event("mouseup",{
        ...
        _getParentOffset: function() {
            var t = this.offsetParent.offset()
              , e = this.document[0];
            return "absolute" === this.cssPosition && this.scrollParent[0] !== e && b.contains(this.scrollParent[0], this.offsetParent[0]) && (t.left += this.scrollParent.scrollLeft(),
        ...
        _setContainment: function() {
            ...
            (i = (e = b(s.containment))[0]) && (t = /(scroll|auto)/.test(e.css("overflow")),
    ...
    b.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(t, e, i) {
            ...
            s.axis && "y" === s.axis || (t.pageX - b(r).scrollLeft() < s.scrollSensitivity ? o = b(r).scrollLeft(b(r).scrollLeft() - s.scrollSpeed) : b(window).width() - (t.pageX - b(r).scrollLeft()) < s.scrollSensitivity && (o = b(r).scrollLeft(b(r).scrollLeft() + s.scrollSpeed)))),
    ...
    b.ui.plugin.add("draggable", "snap", {
        start: function(t, e, i) {
            var s = i.options;
            i.snapElements = [],
            b(s.snap.constructor !== String ? s.snap.items || ":data(ui-draggable)" : s.snap).each(function() {
                var t = b(this)
                  , e = t.offset();
        ...
        drag: function(t, e, i) {
            for (var s, o, n, r, a, h, l, c, p, f = i.options, u = f.snapTolerance, d = e.offset.left, m = d + i.helperProportions.width, g = e.offset.top, v = g + i.helperProportions.height, _ = i.snapElements.length - 1; 0 <= _; _--)
                h = (a = i.snapElements[_].left - i.margins.left) + i.snapElements[_].width,
                c = (l = i.snapElements[_].top - i.margins.top) + i.snapElements[_].height,
                m < a - u || h + u < d || v < l - u || c + u < g || !b.contains(i.snapElements[_].item.ownerDocument, i.snapElements[_].item) ? (i.snapElements[_].snapping && i.options.snap.release && i.options.snap.release.call(i.element, t, b.extend(i._uiHash(), {
                    snapItem: i.snapElements[_].item
                })),
                i.snapElements[_].snapping = !1) : ("inner" !== f.snapMode && (s = Math.abs(l - v) <= u,
                o = Math.abs(c - g) <= u,
                n = Math.abs(a - m) <= u,
                r = Math.abs(h - d) <= u,
                ...
                p = s || o || n || r,
                "outer" !== f.snapMode && (s = Math.abs(l - g) <= u,
                o = Math.abs(c - v) <= u,
                n = Math.abs(a - d) <= u,
                r = Math.abs(h - m) <= u,
                s && (e.position.top = i._convertPositionTo("relative", {
                ...
                !i.snapElements[_].snapping && (s || o || n || r || p) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, b.extend(i._uiHash(), {
                    snapItem: i.snapElements[_].item
                })),
    ...
    b.ui.plugin.add("draggable", "stack", {
        start: function(t, e, i) {
            ...
            i.length && (s = parseInt(b(i[0]).css("zIndex"), 10) || 0,
            b(i).each(function(t) {
    ...
    b.widget("ui.droppable", {
        ...
        _setOption: function(t, e) {
            ...
            : "scope" === t && (i = b.ui.ddmanager.droppables[this.options.scope],
            this._splice(i),
        ...
        _drop: function(e, t) {
            ...
            return !(!i || (i.currentItem || i.element)[0] === this.element[0]) && (this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                if (t.options.greedy && !t.options.disabled && t.options.scope === i.options.scope && t.accept.call(t.element[0], i.currentItem || i.element) && b.ui.intersect(i, b.extend(t, {
    ...
    b.ui.intersect = function(t, e, i, s) {
        if (!e.offset)
            return !1;
    ...
    !(b.ui.ddmanager = {
        ...
        prepareOffsets: function(t, e) {
            var i, s, o = b.ui.ddmanager.droppables[t.options.scope] || [], n = e ? e.type : null, r = (t.currentItem || t.element).find(":data(ui-droppable)").addBack();
            t: for (i = 0; i < o.length; i++)
                if (!(o[i].options.disabled || t && !o[i].accept.call(o[i].element[0], t.currentItem || t.element))) {
                    ...
                    o[i].visible && ("mousedown" === n && o[i]._activate.call(o[i], e),
        ...
        drop: function(t, e) {
            ...
            return b.each((b.ui.ddmanager.droppables[t.options.scope] || []).slice(), function() {
                this.options && (!this.options.disabled && this.visible && b.ui.intersect(t, this, this.options.tolerance, e) && (i = this._drop.call(this, e) || i),
        ...
        drag: function(o, n) {
            ...
            b.each(b.ui.ddmanager.droppables[o.options.scope] || [], function() {
                var t, e, i, s;
                this.options.disabled || this.greedyChild || !this.visible || (s = !(i = b.ui.intersect(o, this, this.options.tolerance, n)) && this.isover ? "isout" : i && !this.isover ? "isover" : null) && (this.options.greedy && (e = this.options.scope,
    ...
    b.widget("ui.sortable", b.ui.mouse, {
        ...
        _mouseCapture: function(t, e) {
            ...
            b(t.target).parents().each(function() {
                if (b.data(this, o.widgetName + "-item") === o)
                    return i = b(this),
                    !1
            }),
            !!(i = b.data(t.target, o.widgetName + "-item") === o ? b(t.target) : i) && (!(this.options.handle && !e && (b(this.options.handle, i).find("*").addBack().each(function() {
                this === t.target && (s = !0)
            }),
        ...
        _mouseStart: function(t, e, i) {
            ...
            this.appendTo = b("parent" !== n.appendTo ? n.appendTo : this.currentItem.parent()),
            ...
            this.storedStylesheet = b("<style>*{ cursor: " + n.cursor + " !important; }</style>").appendTo(o)),
            ...
            b.ui.ddmanager && !n.dropBehaviour && b.ui.ddmanager.prepareOffsets(this, t),
            this.dragging = !0,
        ...
        _mouseDrag: function(t) {
            ...
            n.scroll && !1 !== this._scroll(t) && (this._refreshItemPositions(!0),
            b.ui.ddmanager && !n.dropBehaviour && b.ui.ddmanager.prepareOffsets(this, t)),
            this.dragDirection = {
            ...
            e = this.items.length - 1; 0 <= e; e--)
                ...
                (o = this._intersectsWithPointer(i)) && i.instance === this.currentContainer && !(s === this.currentItem[0] || this.placeholder[1 === o ? "next" : "prev"]()[0] === s || b.contains(this.placeholder[0], s) || "semi-dynamic" === this.options.type && b.contains(this.element[0], s))) {
        ...
        _mouseStop: function(t, e) {
            var i, s, o, n;
            if (t)
                return b.ui.ddmanager && !this.options.dropBehaviour && b.ui.ddmanager.drop(this, t),
                ...
                this.reverting = !0,
                b(this.helper).animate(n, parseInt(this.options.revert, 10) || 500, function() {
                    i._clear(t)
                })) : this._clear(t, e),
                !1
        },
        ...
        _getItemsAsjQuery: function(t) {
            var e, i, s, o, n = [], r = [], a = this._connectWith();
            if (a && t)
                for (e = a.length - 1; 0 <= e; e--)
                    for (i = (s = b(a[e], this.document[0])).length - 1; 0 <= i; i--)
                        (o = b.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && r.push(["function" == typeof o.options.items ? o.options.items.call(o.element) : b(o.options.items, o.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), o]);
            function h() {
                n.push(this)
            }
        ...
        _refreshItems: function(t) {
            ...
            var e, i, s, o, n, r, a, h, l = this.items, c = [["function" == typeof this.options.items ? this.options.items.call(this.element[0], t, {
                item: this.currentItem
            }) : b(this.options.items, this.element), this]], p = this._connectWith();
            if (p && this.ready)
                for (e = p.length - 1; 0 <= e; e--)
                    for (i = (s = b(p[e], this.document[0])).length - 1; 0 <= i; i--)
                        (o = b.data(s[i], this.widgetFullName)) && o !== this && !o.options.disabled && (c.push(["function" == typeof o.options.items ? o.options.items.call(o.element[0], t, {
                            item: this.currentItem
                        }) : b(o.options.items, o.element), o]),
                        this.containers.push(o));
            for (e = c.length - 1; 0 <= e; e--)
                for (n = c[e][1],
                h = (r = c[e][i = 0]).length; i < h; i++)
                    (a = b(r[i])).data(this.widgetName + "-item", n),
                    l.push({
                        item: a,
                        instance: n,
                        width: 0,
        ...
        _refreshItemPositions: function(t) {
            for (var e, i, s = this.items.length - 1; 0 <= s; s--)
                e = this.items[s],
                this.currentContainer && e.instance !== this.currentContainer && e.item[0] !== this.currentItem[0] || (i = this.options.toleranceElement ? b(this.options.toleranceElement, e.item) : e.item,
        ...
        _createPlaceholder: function(i) {
            ...
            n.placeholder = {
                element: function() {
                    var t = b("<" + o + ">", i.document[0]);
                    return i._addClass(t, "ui-sortable-placeholder", s || i.currentItem[0].className)._removeClass(t, "ui-sortable-helper"),
                    "tbody" === o ? i._createTrPlaceholder(i.currentItem.find("tr").eq(0), b("<tr>", i.document[0]).appendTo(t)) : "tr" === o ? i._createTrPlaceholder(i.currentItem, t) : "img" === o && t.attr("src", i.currentItem.attr("src")),
                    s || t.css("visibility", "hidden"),
                    t
                },
                update: function(t, e) {
                    s && !n.forcePlaceholderSize || (e.height() && (!n.forcePlaceholderSize || "tbody" !== o && "tr" !== o) || e.height(i.currentItem.innerHeight() - parseInt(i.currentItem.css("paddingTop") || 0, 10) - parseInt(i.currentItem.css("paddingBottom") || 0, 10)),
            ...
            i.placeholder = b(n.placeholder.element.call(i.element, i.currentItem)),
        ...
        _contactContainers: function(t) {
            for (var e, i, s, o, n, r, a, h, l, c = null, p = null, f = this.containers.length - 1; 0 <= f; f--)
                b.contains(this.currentItem[0], this.containers[f].element[0]) || (this._intersectsWith(this.containers[f].containerCache) ? c && b.contains(this.containers[f].element[0], c.element[0]) || (c = this.containers[f],
                p = f) : this.containers[f].containerCache.over && (this.containers[f]._trigger("out", t, this._uiHash(this)),
            ...
            if (c)
                if (1 === this.containers.length)
                    ...
                    for (i = 1e4,
                    s = null,
                    o = (h = c.floating || this._isFloating(this.currentItem)) ? "left" : "top",
                    n = h ? "width" : "height",
                    l = h ? "pageX" : "pageY",
                    e = this.items.length - 1; 0 <= e; e--)
                        b.contains(this.containers[p].element[0], this.items[e].item[0]) && this.items[e].item[0] !== this.currentItem[0] && (r = this.items[e].item.offset()[o],
                        a = !1,
                        t[l] - r > this.items[e][n] / 2 && (a = !0),
                        Math.abs(t[l] - r) < i && (i = Math.abs(t[l] - r),
                        s = this.items[e],
                        this.direction = a ? "up" : "down"));
                    (s || this.options.dropOnEmpty) && (this.currentContainer !== this.containers[p] ? (s ? this._rearrange(t, s, null, !0) : this._rearrange(t, null, this.containers[p].element, !0),
                    this._trigger("change", t, this._uiHash()),
                    ...
                    this.containers[p].containerCache.over = 1) : this.currentContainer.containerCache.over || (this.containers[p]._trigger("over", t, this._uiHash()),
                    this.currentContainer.containerCache.over = 1))
                }
        },
        _createHelper: function(t) {
            var e = this.options
              , t = "function" == typeof e.helper ? b(e.helper.apply(this.element[0], [t, this.currentItem])) : "clone" === e.helper ? this.currentItem.clone() : this.currentItem;
        ...
        _getParentOffset: function() {
            this.offsetParent = this.helper.offsetParent();
            var t = this.offsetParent.offset();
            return "absolute" === this.cssPosition && this.scrollParent[0] !== this.document[0] && b.contains(this.scrollParent[0], this.offsetParent[0]) && (t.left += this.scrollParent.scrollLeft(),
            t.top += this.scrollParent.scrollTop()),
            {
                top: (t = this.offsetParent[0] === this.document[0].body || this.offsetParent[0].tagName && "html" === this.offsetParent[0].tagName.toLowerCase() && b.ui.ie ? {
                    top: 0,
                    left: 0
                } : t).top + (parseInt(this.offsetParent.css("borderTopWidth"), 10) || 0),
                left: t.left + (parseInt(this.offsetParent.css("borderLeftWidth"), 10) || 0)
        ...
        _setContainment: function() {
            ...
            /^(document|window|parent)$/.test(i.containment) || (t = b(i.containment)[0],
            e = b(i.containment).offset(),
            i = "hidden" !== b(t).css("overflow"),
        ...
        _generatePosition: function(t) {
            var e = this.options
              , i = t.pageX
              , s = t.pageY
              , o = "absolute" !== this.cssPosition || this.scrollParent[0] !== this.document[0] && b.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent
